...
class FillScreenTest {
    ...
    private fun navigateToFillScreen() {
        ...
        composeTestRule.waitForIdle()
        composeTestRule.onNodeWithText(getTestString(R.string.overlay_item_polygon_menu)).performClick()
        composeTestRule.waitForIdle()
    }
    ...
    fun back_returnsToOverlayList() {
        ...
        composeTestRule.onNodeWithText(getTestString(R.string.overlay_item_polygon_menu)).assertIsDisplayed()
        composeTestRule.onNodeWithText(getTestString(R.string.overlay_item_marker)).assertIsDisplayed()
    }
