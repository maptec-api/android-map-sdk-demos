...
/**
 * [LocationLayerScreen] 功能测试：定位图层组件与 UI 控件。
 */
@RunWith(AndroidJUnit4::class)
class LocationLayerScreenTest {
    ...
    private fun navigateToLocationScreen() {
        ...
        composeTestRule.openInteractionDemo(
            R.string.catalog_user_location,
            R.string.map_item_location_layer,
        )
        composeTestRule.waitForIdle()
    }
    ...
    fun locationComponentOptions_defaultValues() {
        withLocationComponent { lc ->
            ...
            assertTrue("Stale 状态应默认开启", opts.enableStaleState())
            assertEquals("Stale 超时应为 30 秒", 30_000L, opts.staleStateTimeout())
        }
    }
    ...
    fun renderModeDropdown_selectModes() {
        ...
        composeTestRule.waitForIdle()
        composeTestRule.onNodeWithText(getTestString(R.string.location_render_mode_normal)).performClick()
        composeTestRule.waitForIdle()
        ...
        composeTestRule.onNodeWithTag("dropdown_render_mode").performClick()
        composeTestRule.waitForIdle()
        composeTestRule.onNodeWithText(getTestString(R.string.location_render_mode_gps)).performClick()
        composeTestRule.waitForIdle()
    ...
    fun back_returnsToMapItemList() {
        ...
        composeTestRule.waitForIdle()
        composeTestRule.onNodeWithText(getTestString(R.string.map_item_location_layer)).assertIsDisplayed()
    }
